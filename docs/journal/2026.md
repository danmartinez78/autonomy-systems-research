...
## 2026-02-22 — GO2 Survey Update: Dimensional (dim.os) Framework

Added a major update to the GO2 embodied AI stack survey covering **Dimensional's dim.os framework** — a Python-native, ROS-optional robotics framework with first-class MCP support for natural language control. This is particularly relevant because it aligns with Dan's goal of controlling the GO2 via OpenClaw through natural language.

Key additions:
- Section 6: High-level overview of Dimensional's positioning and features
- Section 7: Technical deep dive into architecture, MCP integration, skills, navigation, and perception stack
- Hardware support table (GO2 Pro/AIR stable, G1 beta)

Open questions documented for future exploration: WebRTC latency, production readiness, joint control parity with official SDK.

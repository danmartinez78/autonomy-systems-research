...
Published a curated research packet on engineered + emergent personality in tool-using agents (SOUL.md patterns, long-term memory, governed self-modification, measurement, and multi-agent divergence). This is intended as a “seed crystal” for the Tachikoma fleet design work.

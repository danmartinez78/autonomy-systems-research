---
title: "Pre-Read: Generalization from Parameters and Context"
layout: default
...
# Pre-Read: Generalization from Parameters and Context
...
Andrew Lampinen's announced CS25 talk compares two ways models acquire knowledge:

1. **Parameter learning** via training updates
2. **Context learning** via information supplied at inference time

The interesting bit is not just that both work, but that they produce **different generalization behavior**. The talk promises to cover those gaps and three strategies for narrowing them: **data augmentation, retrieval, and reinforcement learning**.

Andrew's broader research still bridges **cognitive science and AI**, with recent work focusing on two major threads:
...
**Slides posted:** [Course slide deck](https://drive.google.com/file/d/1-YIOa5Yal4RCjAsV-0tnW_NNDGbY1GTo/view?usp=sharing)

---

*Prepared: 2026-05-06 • Topic updated: 2026-06-18*

---
title: "Pre-Read: Collaborative AI Agents for Science and Medicine"
layout: default
...
# Pre-Read: Collaborative AI Agents for Science and Medicine
...
The course page now frames this talk around **collaborative AI agents** in two high-stakes settings:

- **AI co-scientist** systems that generate and refine scientific hypotheses
- **AI co-physician / AMIE** systems that assist clinical reasoning and medical expertise

This is less about "medical LLMs are good now" and more about **multi-agent AI as a workflow amplifier** for discovery and care delivery. For autonomy work, that makes it unusually relevant to human-AI teaming, validation, and delegation boundaries.

---

## Key Concepts

- Multi-agent scientific hypothesis generation
- Clinical reasoning assistance and evaluation
- Lab-validated vs benchmark-only evidence
- Human-AI collaboration in safety-critical domains
- Translating assistant patterns into high-stakes autonomy
...
- **Mission-critical autonomy:** evaluation and oversight patterns here map well to "AI assists, human remains accountable"
- **Week 5 (Andrew Lampinen):** complementary angle on what model knowledge lives in parameters vs context/tools
- **Week 8 (Victoria Lin):** multimodality broadens the same "assistant becomes collaborator" story beyond text

---

## Slides Status

**Slides:** No slide link is exposed on the Stanford course page as of June 18, 2026.
